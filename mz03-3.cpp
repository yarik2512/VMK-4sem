...
main()
{
    using numbers::complex_stack, numbers::complex, numbers::eval, std::cout, std::endl, std::string;
    complex_stack a;
    std::vector<std::string> expr = {"(1,2)", "(6,5)", "/"};
    cout << eval(expr, 0).to_string() << endl;
    return 0;
}
